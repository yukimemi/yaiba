...
const JA: Record<string, string> = {
  ...
  "{n} hidden": "{n} 件非表示",
  "{n} hidden — zH to show": "{n} 件非表示 — zH で表示",
  "showing hidden tasks": "非表示のタスクも表示中",
  "hidden tasks are off the list": "非表示のタスクを隠しました",
  "usage: :hidden [on|off]  (bare toggles)": "使い方: :hidden [on|off]（引数なしで切替）",
  "no done tasks to hide": "非表示にできる完了タスクがありません",
  "hide done": "完了を非表示",
  "hide": "非表示にする",
  "unhide": "非表示を解除",
  "usage: :hide [done]": "使い方: :hide [done]",
  "usage: :unhide": "使い方: :unhide",
  "hidden — shown by zH": "非表示フラグ付き — zH で表示中",
  "hide this row (or unhide it) / show hidden rows": "この行を非表示・解除 / 非表示の行を表示",
  "flag hidden — bare: the row · done: every done task": "非表示にする — 引数なし: この行 · done: 完了タスクすべて",
  "take the hidden flag off": "非表示を解除",
  "show or hide the hidden rows": "非表示の行を表示 / 隠す",
