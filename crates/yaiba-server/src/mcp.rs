...
pub struct UpdateTask {
    ...
    #[schemars(
        description = "Enclosing task — id, id prefix, or title. Pass \"none\" or empty string to move to the top level."
    )]
    pub parent: Option<String>,
        ...
        ServerInfo::new(ServerCapabilities::builder().enable_tools().build())
            ...
            .with_instructions(
                "yaiba is a dependency-scheduled plan: you enter durations and \
                 ...
                 use `update_task` with `parent` (or pass empty/\"none\" for top level).\n\n\
