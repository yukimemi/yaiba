...
| `i` `I` `a` `A` | edit the cell under the cursor — the title at the head / tail · `cc` is the title from anywhere |
...
| `h` `l` | out / in — a fold, or a cell once `gd` is up · `⏎` `i` `I` `a` `A` edit it |
